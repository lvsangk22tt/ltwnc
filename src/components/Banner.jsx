...
const Banner = () => {
  return (
    <div className="w-full h-[600px] bg-banner
                        ...
                        <h2 className="text-white text-[40px] font-bold">
                            ...
                            <p className="text-white">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                 Ipsa officia iste magni eveniet ducimus tempora cupiditate ratione et. 
                                Accusantium magni deserunt enim architecto quod ipsum aliquam ex dolore nostrum officiis!
                                </p>
                                <div className="flex items-center space-x-4">
                                    <button className="p-3 text-white
                                    bg-black font-bold text-sm">Chi tiết</button>
                                    <button className="p-3 text-white
                                    bg-red-600 font-bold text-sm">Xem phim</button>
                                </div>
                    </div>
            </div>
